	...
	<div 
		...
		>		
              ...
              <?php foreach ($privillage as $privillages): ?>
                    ...
                    <li class="kt-menu__item " aria-haspopup="true" >
                            <a  href="<?php echo base_url("oficer/group"); ?>" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-layer"></i><span class="kt-menu__link-text">Register Groups </span></a>
                     </li>
         ...
         <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"  data-ktmenu-submenu-toggle="hover">
              ...
              <div class="kt-menu__submenu ">
                     ...
                     <ul class="kt-menu__subnav">
                            ...
                            <!-- <li class="kt-menu__item " aria-haspopup="true" >
                                   <a  href="<?php echo base_url("oficer/mycustomer"); ?>" class="kt-menu__link ">
                                          <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                 <span></span>
                                          </i>
                                          <span class="kt-menu__link-text">My Customer</span>
                                   </a>
                            </li> -->
