                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control" readonly name="comp_name" type="text" value="<?php echo $comp_data->comp_name; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label">Company Registration No.</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control" readonly name="comp_number" type="number" value="<?php echo $comp_data->comp_number; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label">Address</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control" readonly name="adress" type="text" value="<?php echo $comp_data->adress; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group">
                                                ...
                                                <input type="number" readonly name="comp_phone" class="form-control" value="<?php echo $comp_data->comp_phone; ?>" placeholder="Phone" aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group">
                                                ...
                                                <input type="email" readonly name="comp_email" class="form-control" value="<?php echo $comp_data->comp_email; ?>" placeholder="Email" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
